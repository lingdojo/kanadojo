...

  {
    ...
    themes: [
      ...
      },
      {
        ...
        backgroundColor: "hsla(207, 37%, 15%, 1)",
        cardColor: "hsla(198, 35%, 20%, 1)",
        borderColor: "hsla(184, 81%, 46%, 1)",
        mainColor: "hsla(83, 74%, 65%, 1)",
        secondaryColor: "hsla(193, 100%, 81%, 1)",
      },
      {
        id: "golden-twilight-grove",
        backgroundColor: "hsla(105, 22%, 11%, 1)",
        cardColor: "hsla(40, 40%, 16%, 1)",
        borderColor: "hsla(35, 78%, 32%, 1)",
        mainColor: "hsla(45, 96%, 67%, 1)",
        secondaryColor: "hsla(155, 43%, 59%, 1)",
      },
      {
        id: "dreamwave-mirage",
      ...
      },
      {
        ...
        backgroundColor: "hsla(280, 98%, 8%, 1)",
        cardColor: "hsla(280, 98%, 13%, 1)",
        borderColor: "hsla(280, 98%, 21%, 1)",
        mainColor: "hsla(194, 100%, 55%, 1)",
        secondaryColor: "hsla(96, 100%, 55%, 1)",
      },
      {
        id: "velvet-bloom",
        backgroundColor: "hsla(280, 55%, 12%, 1)",
        cardColor: "hsla(280, 52%, 17%, 1)",
        borderColor: "hsla(280, 48%, 25%, 1)",
        mainColor: "hsla(330, 75%, 68%, 1)",
        secondaryColor: "hsla(285, 65%, 72%, 1)",
      },
      {
        id: "coral-abyss",
