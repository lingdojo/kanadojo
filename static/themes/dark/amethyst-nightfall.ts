...
export const amethystNightfallTheme: ThemeDefinition = {
  ...
  foreground: 'oklch(0.630 0.216 289)',
  card: 'oklch(0.180 0.114 277)',
  cardForeground: 'oklch(0.630 0.216 289)',
  popover: 'oklch(0.180 0.114 277)',
  popoverForeground: 'oklch(0.630 0.216 289)',
  primary: 'oklch(0.922 0 0)',
  primaryForeground: 'oklch(0.120 0.102 277)',
  secondary: 'oklch(0.180 0.114 277)',
  secondaryForeground: 'oklch(0.630 0.216 289)',
  muted: 'oklch(0.180 0.114 277)',
  mutedForeground: 'oklch(0.650 0.231 214)',
  accent: 'oklch(0.180 0.114 277)',
  accentForeground: 'oklch(0.630 0.216 289)',
